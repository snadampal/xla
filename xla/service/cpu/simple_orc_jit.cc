...
static CompilerFunctor::TargetMachineBuilder
CreateInferTargetMachineForJITBuilder(llvm::TargetOptions target_options,
                                      llvm::CodeGenOptLevel opt_level) {
...
SimpleOrcJIT::SimpleOrcJIT(
    ...
    : target_machine_builder_(
          CreateInferTargetMachineForJITBuilder(target_options, opt_level)),
