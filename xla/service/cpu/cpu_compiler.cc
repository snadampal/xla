      ...
      llvm::SplitModule(
          *llvm_module, num_parts,
          [&, n = 0](std::unique_ptr<llvm::Module> llvm_module_part) mutable {
            // Remove unused symbols that left in the module after splitting.
            ...
            size_t dylib_index = n++ % parallel_codegen_split_count;
            cantFail((*jit)->AddModule(std::move(tsm), dylib_index));
          },
